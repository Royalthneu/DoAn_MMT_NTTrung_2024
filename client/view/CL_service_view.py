...
class service_view:
    ...
    def create_widgets(self):
        ...
        self.tree_app_1.place(relx=0.05, rely=0.27, relheight=0.703, relwidth=0.893)
        ...
        self.btn_stop_service = self.widget_factory.create_button("STOP BY PID", 0.55, 0.043, 87, 36)
        self.btn_stop_service.configure(command= self.btn_stop_service_click)
        
        self.btn_stop_service_by_name = self.widget_factory.create_button("STOP BY NAME", 0.55, 0.153, 87, 36)
        self.btn_stop_service_by_name.configure(command= self.btn_stop_service_by_name_click)
    ...
    def btn_start_service_click(self):
        ...
        open_wd_client_socket_from(self.top, self.client_socket, self.controller, frm_nhap_Ten_view, from_screen="service_view_btn_start")   
    ...
    def btn_stop_service_by_name_click(self):
        from view.CL_frm_nhap_Ten_view import frm_nhap_Ten_view
        open_wd_client_socket_from(self.top, self.client_socket, self.controller, frm_nhap_Ten_view, from_screen="service_view_btn_stop") 
